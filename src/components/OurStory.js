...
function OurStory() {
    ...
    return (
        <div className='text-center'>
            <h1 className='text-5xl font-bold border-b-2 border-gray-500 inline-block pb-4 mt-10'>
            ...
            <div className='flex flex-col md:flex-row mt-14 justify-between items-center mx-4 md:mx-14'>
                <div className='w-full md:w-1/2 md:pr-8'>
                    ...
                    {!showMore && (
                        <button
                            className='bg-yellow-400 text-black text-lg p-2 rounded-lg px-3 mt-4 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 '
                    ...
                    {showMore && (
                        <div className='text-lg relative'>
                            ...
                            <button
                                className='bg-yellow-400 text-black text-lg p-2 rounded-lg px-3 absolute -bottom-10 right-2 m-4 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 '
                                onClick={toggleShowMore}
                            >
                                Show Less
                            </button>
