...
function ContactForm() {
    ...
    return (
        <div className="container px-2 sm:px-4"> {/* Reduced left and right padding */}
                ...
                <div className='border border-gray-300 rounded-lg p-3 sm:p-5 w-full lg:w-1/2 mb-4 lg:mb-0'> {/* Adjusted padding */}
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4 text-sm sm:text-base mt-4 sm:mt-6">
                        ...
                        <div className="flex justify-between mt-4">
                            ...
                            {step < 3 ? (
                                <button type="button" onClick={nextStep} className="bg-blue-500 text-white py-1 sm:py-2 px-2 sm:px-4 rounded text-sm sm:text-base">
                                    Next
                                </button>
                            ) : (
                                <button type="submit" className="bg-yellow-400 text-black py-1 sm:py-2 px-2 sm:px-4 rounded text-sm sm:text-base">
                                    Submit
                                </button>
                            )}
                        </div>
                        ...
                        <div className='mt-2 sm:mt-3 hover:shadow-xl w-full sm:w-1/2'>
                            ...
                            <div className="flex flex-col md:flex-row justify-between p-1 sm:p-2 gap-1 sm:gap-2">
                                <div className='text-start p-2 sm:p-3'>
                                    <p className="text-xs sm:text-sm">Vikram Aviation Pvt Ltd
                                        Plot No. 02
                                        Khasra No. 348/02
                                        Vill Sahabad,
                                        Muhammadpur
                            ...
                            <p className="mt-2 sm:mt-4 text-blue-500 text-start px-2 sm:px-4 text-xs sm:text-sm">info@vikramaviation.com</p>
                        </div>
                    </div>
                </div>
            </div>
