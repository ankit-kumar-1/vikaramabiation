    ...
    return (
        <div className='m-4 md:m-8 lg:m-12'>
            <div className='text-center'>
                <h1 className='text-3xl md:text-4xl lg:text-5xl font-bold border-b-2 border-gray-500 inline-block pb-2 md:pb-4'>
            ...
            <div className='flex flex-col lg:flex-row justify-between items-center mt-8 gap-6 lg:gap-10'>
                <div className='w-full lg:w-1/2 p-4 md:p-5 border border-gray-300 rounded-lg text-center'>
                    ...
                    <button
                        className='bg-yellow-400 hover:bg-yellow-500 text-black text-base md:text-lg lg:text-xl p-2 rounded-lg px-4 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-110'
